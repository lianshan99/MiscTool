...
class Verify():
    public_key = 'D:/MiscTool/trunk/Library/Component/Passport/key/public_key.pem'  # 公钥
    private_key = 'D:/MiscTool/trunk/Library/Component/Passport/key/private_key.pem'  # 私钥

    def __init__(self, client_type='', app_version=''):
        # todo 根据不同客户端和app版本号 做处理
        return
